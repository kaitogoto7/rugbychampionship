...
home.argentina.matrix <- extract.score.cells.from.webpage.special(home.argentina.2016.to.2018.page)
write.csv(home.argentina.matrix, "./RCHomeAdvantages/home.argentina.matrix.csv")

away.argentina.matrix <- extract.score.cells.from.webpage.special(away.argentina.2016.to.2018.page)
write.csv(away.argentina.matrix, "./RCHomeAdvantages/away.argentina.matrix.csv")
```